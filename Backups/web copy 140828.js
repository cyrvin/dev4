...
app.get('/europages/test1/', function(req, res) {
	europagesTest1('http://www.europages.fr/GUTENBERG-NETWORKS/FRA625646-00101.html');
});

function europagesTest1(companyUrl) {
